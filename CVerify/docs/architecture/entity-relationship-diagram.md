...
### 3.1 Identity & Access Management (IAM) Sub-ERD
...
erDiagram
    ...
    Organization ||--o{ OrganizationCredential : "OrganizationId"
    User ||--o{ PendingAuthProvider : "UserId"
    Organization |o--o{ RefreshToken : "OrganizationId"
    User |o--o{ RefreshToken : "UserId"
    User ||--o{ ResetPasswordToken : "UserId"
    Organization |o--o{ VerificationLink : "OrganizationId"
    User |o--o{ VerificationLink : "UserId"
    User ||--o{ VerificationToken : "UserId"
    User ||--o{ ForumBookmark : "UserId"
    User ||--o{ ForumCategoryModerator : "UserId"
    User ||--o{ ForumFollow : "UserId"
    User ||--o{ ForumModerationLog : "ModeratorId"
    User ||--o{ ForumReaction : "UserId"
    User ||--o{ ForumReply : "AuthorId"
    User ||--o{ ForumReplyHistory : "EditedById"
    User |o--o{ ForumReport : "ReportedUserId"
    User ||--o{ ForumReport : "ReporterUserId"
    User |o--o{ ForumReport : "ResolvedById"
    User ||--o{ ForumReputation : "UserId"
    User ||--o{ ForumTopic : "AuthorId"
    User ||--o{ ForumTopicHistory : "EditedById"
    User ||--o{ ForumUserBadge : "UserId"
    User ||--o{ ForumVote : "UserId"
    User ||--o{ AcademicAchievement : "UserId"
    User ||--o| AiInferredPreference : "CVerify.API.Modules.Profiles.Entities.AiInferredPreference, UserId"
    User ||--o{ CandidateAssessment : "UserId"
    User ||--o| CareerPreference : "CVerify.API.Modules.Profiles.Entities.CareerPreference, UserId"
    User ||--o{ EducationEntry : "UserId"
    User ||--o{ ProfileAttachment : "UserId"
    User ||--o{ ProjectEntry : "UserId"
    User ||--o| UserProfile : "CVerify.API.Modules.Profiles.Entities.UserProfile, UserId"
    User ||--o{ UserSkill : "UserId"
    User ||--o{ WorkExperienceEntry : "UserId"
    User |o--o{ RecoveryToken : "UserId"
    User ||--o{ RepresentativeApprovalVote : "ApproverUserId"
    User |o--o{ ActivityEvent : "ActorUserId"
    User |o--o{ AdminInvitation : "ConsumedByUserId"
    User |o--o{ AdminInvitation : "InvitedByUserId"
    Role ||--o{ AdminInvitationRole : "RoleId"
    User |o--o{ AdminMember : "AssignedByUserId"
    User ||--o{ AdminMember : "UserId"
    User |o--o{ AiStreamingSession : "UserId"
    User |o--o{ AuditLog : "ActorUserId"
    User |o--o{ AuditLog : "TargetUserId"
    User |o--o{ AuditLog : "UserId"
    User ||--o{ CandidateCapability : "CandidateId"
    User ||--o| CandidateCapabilityProjection : "CVerify.API.Modules.Shared.Domain.Entities.CandidateCapabilityProjection, CandidateId"
    User |o--o{ CandidateDiscoveryRun : "TriggeredById"
    User ||--o| CandidateEvaluationSnapshot : "CVerify.API.Modules.Shared.Domain.Entities.CandidateEvaluationSnapshot, CandidateId"
    User ||--o| CandidateMatchProjection : "CVerify.API.Modules.Shared.Domain.Entities.CandidateMatchProjection, CandidateId"
    User ||--o| CandidateRankingProjection : "CVerify.API.Modules.Shared.Domain.Entities.CandidateRankingProjection, CandidateId"
    User ||--o| CandidateSearchProfile : "CVerify.API.Modules.Shared.Domain.Entities.CandidateSearchProfile, CandidateId"
    User ||--o| CandidateTrustProjection : "CVerify.API.Modules.Shared.Domain.Entities.CandidateTrustProjection, CandidateId"
    User ||--o{ EvidenceClaim : "CandidateId"
    User ||--o{ InAppNotification : "UserId"
    User ||--o{ JobApplication : "CandidateId"
    User ||--o{ JobInteraction : "UserId"
    User ||--o{ MatchingEvaluation : "CandidateId"
    User ||--o{ NotificationPreference : "UserId"
    User ||--o{ OrganizationAuthority : "UserId"
    User |o--o{ OrganizationInvitation : "ConsumedByUserId"
    User |o--o{ OrganizationInvitation : "InvitedByUserId"
    Role ||--o{ OrganizationInvitationRole : "RoleId"
    User ||--o{ OrganizationMembership : "UserId"
    User |o--o{ PendingOrganizationOwnership : "ConsumedByUserId"
    ...
    User ||--o{ WorkspacePost : "CreatedByUserId"
    User ||--o{ AnalysisExecution : "UserId"
    User ||--o{ AnalysisJob : "UserId"
    AuthProvider ||--o{ ExternalOrganization : "AuthProviderId"
    AuthProvider ||--o{ SourceCodeRepository : "AuthProviderId"
...
### 3.2 Organizations & Workspaces Sub-ERD
...
erDiagram
    ...
    Organization |o--o{ RefreshToken : "OrganizationId"
    Organization |o--o{ VerificationLink : "OrganizationId"
    Organization |o--o{ ForumCategory : "OrganizationId"
    Organization |o--o{ ForumTopic : "OrganizationId"
    Organization ||--o{ ApprovedRecoverySession : "OrganizationId"
    Organization ||--o{ OrganizationRecoveryClaim : "OrganizationId"
    Organization |o--o{ RecoveryToken : "OrganizationId"
    Organization ||--o{ RepresentativeAuthorityHistory : "OrganizationId"
    Organization ||--o{ RepresentativeRotationRequest : "OrganizationId"
    Organization |o--o{ ActivityEvent : "OrganizationId"
    Workspace |o--o{ AiStreamingSession : "WorkspaceId"
    Organization |o--o{ AuditLog : "OrganizationId"
    Workspace |o--o{ CapabilityCatalogItem : "WorkspaceId"
    Organization ||--o{ HiringRequirement : "OrganizationId"
    Workspace ||--o{ HiringRequirement : "WorkspaceId"
    Organization ||--o{ JobVacancy : "OrganizationId"
...
### 3.3 Candidate Profiles Sub-ERD
...
erDiagram
    ...
    User ||--o| CareerPreference : "CVerify.API.Modules.Profiles.Entities.CareerPreference, UserId"
    SourceCodeRepository ||--o{ CvRepositoryMapping : "SourceCodeRepositoryId"
    User ||--o{ EducationEntry : "UserId"
    User ||--o{ ProfileAttachment : "UserId"
    ProjectEntry ||--o{ ProjectContribution : "ProjectEntryId"
    User ||--o{ ProjectEntry : "UserId"
    ProjectEntry ||--o{ ProjectRepositoryLink : "ProjectEntryId"
    SourceCodeRepository ||--o{ ProjectRepositoryLink : "SourceCodeRepositoryId"
...
### 3.4 Talent Intelligence & Verification Sub-ERD
...
erDiagram
    ...
    HiringRequirement ||--o{ EvaluationRubric : "HiringRequirementId"
    RequirementSnapshot ||--o| EvaluationRubricSnapshot : "CVerify.API.Modules.Shared.Domain.Entities.EvaluationRubricSnapshot, RequirementSnapshotId"
    ...
    User ||--o{ MatchingEvaluation : "CandidateId"
    JobVacancy ||--o{ MatchingEvaluation : "JobVacancyId"
    CapabilityNode |o--o{ MatchingExplanation : "CapabilityNodeId"
    MatchingEvaluation ||--o{ MatchingExplanation : "MatchingEvaluationId"
    EvidenceArtifact |o--o{ MatchingExplanation : "SupportingArtifactId"
    MatchingEvaluation ||--o{ MatchingFactor : "MatchingEvaluationId"
    HiringRequirement ||--o{ RequirementCapability : "HiringRequirementId"
    TrustProfile ||--o{ TrustCalculation : "TrustProfileId"
    TrustProfile ||--o{ TrustComponent : "TrustProfileId"
```

### 3.5 Recruitment & Jobs Sub-ERD
...
erDiagram
    ...
    HiringRequirement ||--o{ BusinessOutcome : "HiringRequirementId"
    HiringRequirement ||--o{ CandidateDiscoveryRun : "HiringRequirementId"
    HiringRequirement ||--o{ EvaluationRubric : "HiringRequirementId"
    RequirementSnapshot ||--o| EvaluationRubricSnapshot : "CVerify.API.Modules.Shared.Domain.Entities.EvaluationRubricSnapshot, RequirementSnapshotId"
    Organization ||--o{ HiringRequirement : "OrganizationId"
    Workspace ||--o{ HiringRequirement : "WorkspaceId"
    ...
    PipelineJob ||--o{ PipelineTask : "JobId"
```

### 3.6 Source Code Intelligence Sub-ERD
...
### 3.8 Audit, Notifications & Messaging Sub-ERD
...
### 3.9 Platform Orchestration & AI Subsystem Sub-ERD
...
### 3.11 Organization Recovery Sub-ERD
...
Below is the complete, system-wide entity relationship diagram including all 151 entities and 200 relationships. (Note: Only primary keys, foreign keys, and status/type fields are shown in this diagram to ensure readability).
