...
import { Globe, MapPin, Briefcase, Calendar, Info, Heart, Target, Eye, Phone, Mail } from "lucide-react";
        ...
        <Card className="p-6 md:p-8 bg-surface border border-border rounded-2xl">
          <div className="space-y-4">
            <Typography type="h3" className="font-bold text-foreground">
              {isEn ? `About ${workspaceDetails.organizationName}` : `Giới thiệu về ${workspaceDetails.organizationName}`}
            </Typography>
        ...
        {(workspaceDetails.mission || workspaceDetails.vision || workspaceDetails.coreValues) && (
          <Card className="p-6 md:p-8 bg-surface border border-border rounded-2xl">
            <div className="space-y-6">
              <Typography type="h3" className="font-bold text-foreground">
                {isEn ? "Corporate Pillars" : "Giá trị cốt lõi"}
              </Typography>
              ...
              <div className="pt-3 border-t border-separator/40 space-y-2">
                ...
                {workspaceDetails.contactEmail && (
                  <div className="flex items-center gap-1.5 text-muted-foreground">
                    ...
                    <a href={`mailto:${workspaceDetails.contactEmail}`} className="text-accent hover:underline break-all font-medium">
                      {workspaceDetails.contactEmail}
                    </a>
                  </div>
                )}
