...
Whenever implementing, modifying, deleting, or refactoring any frontend functionality in the CVerify client application, follow the workflow below to ensure architectural consistency, UI quality, maintainability, and production readiness.
...
The MCP lookup should happen before coding begins to ensure:
...
Do not introduce inconsistent visual styles or mixed component systems.

5. ESLint & Type Safety Enforcement
