...
public class EmailService : IEmailService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var message = new EmailMessage(
            ToEmail: toEmail,
            ToName: fullName,
            Subject: "Verify Your Email Address - TripGenie AI",
            HtmlContent: htmlBody,
            PlainTextContent: $"Hi {fullName}, please confirm your TripGenie AI account by visiting this link: {verificationLink}",
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var message = new EmailMessage(
            ToEmail: toEmail,
            ToName: fullName,
            Subject: "Reset Your Password - TripGenie AI",
            HtmlContent: htmlBody,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var message = new EmailMessage(
            ToEmail: toEmail,
            ToName: fullName,
            Subject: "Welcome to TripGenie AI! ✈️",
            HtmlContent: htmlBody,
            PlainTextContent: $"Welcome to TripGenie AI, {fullName}! Your account is verified and ready for travel planning.",
            CorrelationId: correlationId,
