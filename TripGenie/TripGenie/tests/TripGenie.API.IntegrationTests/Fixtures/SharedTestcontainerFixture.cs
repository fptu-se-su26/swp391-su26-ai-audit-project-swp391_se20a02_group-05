...
public class SharedTestcontainerFixture : IAsyncLifetime
{
    static SharedTestcontainerFixture()
    {
        ...
        Environment.SetEnvironmentVariable("DB_NAME", "tripgenie_db");
    ...
    private readonly PostgreSqlContainer _dbContainer = new PostgreSqlBuilder()
        .WithDatabase("tripgenie_integration_db")
    ...
    private async Task InitializeDbSchemaAsync()
    {
        ...
        var scriptPath = @"d:\Coding Space\FPT\SWP391\swp391-su26-ai-audit-project-swp391_se20a02_group-05\TripGenie\resources\Initialize SQL.sql";
