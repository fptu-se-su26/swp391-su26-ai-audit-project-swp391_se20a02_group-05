...
settings.client_id = "tripgenie-core"
...
class TestTripGenieAiMicroservice(unittest.TestCase):
    def setUp(self):
    ...
    def test_health_check_endpoint(self):
        ...
        self.assertEqual(data["service"], "TripGenie.AI")
