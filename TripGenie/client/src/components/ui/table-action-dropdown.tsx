      ...
      <Dropdown>
        <Dropdown.Trigger>
          <Button
            ...
            className="h-8 w-8 min-w-8 rounded-lg bg-surface-secondary/40 border-border/60 hover:bg-surface-secondary text-muted hover:text-foreground cursor-pointer focus-visible:ring-2 focus-visible:ring-focus focus-visible:outline-hidden transition-all duration-150"
          >
