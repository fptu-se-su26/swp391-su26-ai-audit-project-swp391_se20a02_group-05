...
public class AuthFlowsApiTests : BaseIntegrationTest
{
    ...
    public async Task E2E_Auth_And_Deletion_Lifecycle_Should_Succeed()
    {
        ...
        {
            var db = scope.ServiceProvider.GetRequiredService<ApplicationDbContext>();
            var user = await db.Users.FirstOrDefaultAsync(u => u.Email == "lifecycle@tripgenie.ai");
        ...
        // =========================================================
        var loginRequest = new LoginRequest(Email: "lifecycle@tripgenie.ai", Password: "SecurePassword123!");
        ...
        authData!.Email.Should().Be("lifecycle@tripgenie.ai");
        ...
        // =========================================================
        var forgotRequest = new ForgotPasswordRequest(Email: "lifecycle@tripgenie.ai");
        ...
        var reLoginRequest = new LoginRequest(Email: "lifecycle@tripgenie.ai", Password: "NewSecurePassword456!");
    ...
    public async Task Register_With_Existing_Active_Email_Should_Fail()
    {
        ...
        {
            var db = scope.ServiceProvider.GetRequiredService<ApplicationDbContext>();
            var user = await db.Users.FirstOrDefaultAsync(u => u.Email == "duplicate@tripgenie.ai");
