...
namespace TripGenie.API.IntegrationTests.Email;
...
public class EmailApiTests : BaseIntegrationTest
{
    ...
    public async Task SendVerification_ShouldEnqueueEmailAndReturnSuccess()
    {
        ...
        var request = new
        {
            ...
            verificationLink = "https://tripgenie.ai/verify?token=api_integration_test_123"
        };
    ...
    public async Task SendVerification_ShouldTriggerIdempotencyAndBlockDuplicateRequests()
    {
        ...
        var request = new
        {
            ...
            verificationLink = "https://tripgenie.ai/verify?token=idempotency_token_abc"
        };
    ...
    public async Task SendReset_ShouldEnqueueEmailAndReturnSuccess()
    {
        ...
        var request = new
        {
            ...
            fullName = "Reset User",
            resetLink = "https://tripgenie.ai/reset?token=api_integration_reset_abc"
        };
