...
```text
AI should be provided with specific context, persona, task definitions, and constraints
```

### 8.2. Em/nhóm đã học được gì về cách đặt câu hỏi cho AI?

```text
Effective prompting is not magic or just asking for things; it is a clear, deliberate delegation of tasks that provides the AI with necessary roles, context, and constraints
```

### 8.3. Lần sau em/nhóm sẽ cải thiện prompt như thế nào?

```text
The biggest improvement came from treating prompts like workflows. Instead of asking the model to do everything in one step, break the task down.
```
