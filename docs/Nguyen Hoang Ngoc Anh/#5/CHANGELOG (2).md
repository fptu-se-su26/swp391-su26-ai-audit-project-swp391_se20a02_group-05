...
|---|---|---|---|
| Phase 01 | 0009-05-20 ~ 2026-05-20 | Khởi tạo project | Completed |
...
- **Thời gian thực hiện:** 0009-05-20 ~ 2026-05-20
...
|---:|---|---|---|---|
| 1 | Xây dựng idea ý tưởng mới cho dự án môn học | Nguyễn Hoàng Ngọc Ansh |   |   |
...
```text
Làm rõ nội dung và hướng đi của ý tưởng web app chăm sóc trẻ em
```
