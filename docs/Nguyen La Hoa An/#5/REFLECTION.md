...
| Ngày hoàn thành reflection | 2026-07-02 |
...
```text
Yes. AI helps me better understand the software testing process, how to build valid test cases, and determine expected outcomes. AI also assists in suggesting test scenarios, helping me expand the scope of testing and improve the quality of system evaluation. However, I still manually check, adjust, and verify all test cases before using them.
```

### 6.2. Những điểm AI chưa giúp tốt hoặc gây khó khăn

```text
AI sometimes creates test cases that are too general, failing to fully reflect the project's business logic.

Some expected results need to be adjusted to better reflect how the application actually works.
AI cannot independently verify whether test cases are correct for the system because it lacks the authority to run the application or observe the actual results.

AI may miss some project-specific test cases, requiring additions based on the developer's understanding.
```
...
|---|---|
| Nguyễn Hoàng Ngọc Ánh | 2/7/2026 |
